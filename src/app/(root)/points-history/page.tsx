                      ...
                      <div className="flex flex-col md:flex-row w-full items-start md:items-center justify-between pr-4">
                        <div className="flex items-center gap-3">
                          <div className="flex items-center">
                            <Badge
                              className={`${teamColors[match.homeTeamName]} text-white`}
                            >
                              {match.homeTeamName}
                            </Badge>
                            <span className="mx-2 text-xs md:text-sm">vs</span>
                            <Badge
                              className={`${teamColors[match.awayTeamName]} text-white`}
                            >
                              {match.awayTeamName}
                            </Badge>
                          </div>
                        ...
                        <div className="flex items-center gap-4 mt-2 md:mt-0">
                          ...
                          <div className="flex items-center gap-1 text-xs md:text-sm text-muted-foreground">
                            ...
                            <span>{formatLocalTime(match.datetimeUtc)}</span>
                          </div>
                          <Badge
                            variant="outline"
